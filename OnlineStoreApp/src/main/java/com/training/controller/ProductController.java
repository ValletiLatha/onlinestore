...
public class ProductController {
	...
	/**
	 * This method is used to based on categoryId we have to know the what are the available categories in it.
	 * @author Latha V
	 * @param categoryId
	 * @return
	 */
	...
	/**
	 * In this API we are going to get the details about that particular product based on productId.
	 * @author Latha V
	 * @param productId
	 * @return
	...
	public ResponseEntity<Product> productDetails(@PathVariable("productId") Integer productId) throws ProductException {
